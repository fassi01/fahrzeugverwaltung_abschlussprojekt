<div class="baseHeader">
	<h1>Fahrzeug Rückgabe</h1>
</div>

<div class="mainView">
	<div class="viewHeader">
		<div>zu Überlassung ID<input id="sucheFahrer"/></div>
	</div>
	<div class="viewTable">
		<div class="left">
		...
		<div class="right">
			<div class="designation">
				<div class="text">Rückgabedatum</div>
				<div class="text">Rückgabe KM-Stand</div>
				<div class="text">Rückgabe durch</div>
				<div class="text">Rückgabe Sommerreifen</div>
				<div class="text">Rückgabe Winterreifen</div>
				<div class="text">Rückgabe Schlüssel</div>
			</div>
			<div class="dropdown">
				<div><input class="input" size="25"/></div>
				<div><input class="input" size="25"/></div>
	...
	<div class="viewButtons">
		...
		<button class="Buttons">Neue Rücknahme</button>
		<button class="Buttons">Speicher</button>
		<button class="Buttons">Löschen</button>
		<button class="Buttons">Rückgabe drucken</button>
	</div>
